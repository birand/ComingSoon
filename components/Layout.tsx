...
const Layout = ({ children, title = "This is the default title" }: Props) => (
  <div className="relative min-h-screen flex flex-col justify-center items-center bg-hero bg-cover">
    <Head>
      ...
      <meta
        name="description"
        content="CoolNFT NEW GENERATION NFT MARKETPLACE"
      />
    ...
    <Script src="https://www.googletagmanager.com/gtag/js?id=G-FL8PVHPK9C" strategy="afterInteractive" />
